...
$w.onReady(async () => {
    ...
    $w("#btnSalvarRecompensa").onClick(async () => {
        const novaRecompensa = {
            ...
            pontosTotais: Number($w("#inputPontosTotais").value || 0),
...
async function atualizarRepeaterUsuarios() {
    ...
    $w('#repeaterUsuarios').onItemReady(($item, itemData) => {
        ...
        $item('#textTotalPontos').text = String(itemData.pontosTotaisAcumulados);
...
async function atualizarRepeaterRecompensas() {
    ...
    $w("#repeaterRecompensas").onItemReady(($item, itemData) => {
        ...
        $item("#textPontosTotais").text = itemData.pontosTotais != null ? String(itemData.pontosTotais) : "—";
        ...
        $item("#btnEditarRecompensa").onClick(() => {
            ...
            $w("#inputPontosTotais").value = itemData.pontosTotais != null ? String(itemData.pontosTotais) : "";
